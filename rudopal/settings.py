...
"""
Django settings for rudopal project.
...
SECRET_KEY = 'a3c(h7rm)-v$!6-n)uy7r*%=mg-3s+o0gk5@=z*ns+3w@l&y7%'
...
ROOT_URLCONF = 'rudopal.urls'



WSGI_APPLICATION = 'rudopal.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'rudopal', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'rudopal', 'templates'),],
        'OPTIONS': {
            'context_processors': [
...
LOCALE_PATHS = (
   '/home/wisnia/rudopal-project/locale',
)